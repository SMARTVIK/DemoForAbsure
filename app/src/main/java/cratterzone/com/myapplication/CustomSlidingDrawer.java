...
//
///**
// * Created by user05 on 12-06-2015.
// */
...
//    public CustomSlidingDrawer(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
//        super(context, attrs, defStyleAttr, defStyleRes);
//
//        final TypedArray a = context.obtainStyledAttributes(
//                attrs, R.styleable.MySlider, defStyleAttr, defStyleRes);
//
...
//        mBottomOffset = (int) a.getDimension(R.styleable.MySlider_SlidingDrawer_bottomOffset, 0.0f);
//        mTopOffset = (int) a.getDimension(R.styleable.MySlider_SlidingDrawer_topOffset, 0.0f);
//        mAllowSingleTap = a.getBoolean(R.styleable.MySlider_SlidingDrawer_allowSingleTap, true);
//        mAnimateOnClick = a.getBoolean(R.styleable.MySlider_SlidingDrawer_animateOnClick, true);
//
//        int handleId = a.getResourceId(R.styleable.MySlider_SlidingDrawer_handle, 0);
//        if (handleId == 0) {
//            throw new IllegalArgumentException("The handle attribute is required and must refer "
//                    + "to a valid child.");
//        }
//
//        int contentId = a.getResourceId(R.styleable.MySlider_SlidingDrawer_content, 0);
//        if (contentId == 0) {
